...
void main() {
  group('parseMakeModel', () {
    final okCases = <_Expectation>[
      const _Expectation(
          'Latitude 7420', ParseStatus.ok, 'Dell', 'Latitude', '7420'),
      const _Expectation(
          'Latitude-7420', ParseStatus.ok, 'Dell', 'Latitude', '7420'),
      const _Expectation(
          'Latitude_7420', ParseStatus.ok, 'Dell', 'Latitude', '7420'),
      const _Expectation(
          'Lat 7420', ParseStatus.ok, 'Dell', 'Latitude', '7420'),
      const _Expectation(
      ...
      const _Expectation(
          'ProBook-450 G9', ParseStatus.ok, 'HP', 'ProBook', '450 G9'),
      const _Expectation(
          'XPS 13 9310', ParseStatus.ok, 'Dell', 'XPS', '13 9310'),
      const _Expectation('  dell   latitude   5540  ', ParseStatus.ok, 'Dell',
          'Latitude', '5540'),
      const _Expectation(
