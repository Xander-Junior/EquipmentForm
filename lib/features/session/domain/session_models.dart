...
class PartyFieldState with _$PartyFieldState {
  ...
  factory PartyFieldState.fromJson(Map<String, dynamic> json) =>
      _$PartyFieldStateFromJson(json);
}
...
class PartyMemberState with _$PartyMemberState {
  ...
  factory PartyMemberState.fromJson(Map<String, dynamic> json) =>
      _$PartyMemberStateFromJson(json);
}
...
List<PartyRole> partyRolesForForm(FormType formType) {
  switch (formType) {
    case FormType.received:
      return const [
        PartyRole.requestedBy,
        PartyRole.preparedBy,
        PartyRole.receivedBy
      ];
    case FormType.returned:
      return const [
        PartyRole.returnedBy,
        PartyRole.preparedBy,
        PartyRole.receivedBy
      ];
...
class PartySessionState with _$PartySessionState {
  ...
  factory PartySessionState.fromJson(Map<String, dynamic> json) =>
      _$PartySessionStateFromJson(json);
}
...
class AccessoryState with _$AccessoryState {
  ...
  factory AccessoryState.fromJson(Map<String, dynamic> json) =>
      _$AccessoryStateFromJson(json);
}
...
class PrimaryDeviceState with _$PrimaryDeviceState {
  const factory PrimaryDeviceState({
    ...
    @MakeModelConverter() required String makeModel,
    String? assetTag,
    String? serviceTag,
    String? serialNumber,
  ...
  factory PrimaryDeviceState.fromJson(Map<String, dynamic> json) =>
      _$PrimaryDeviceStateFromJson(json);
}
...
class EquipmentSessionState with _$EquipmentSessionState {
  ...
  factory EquipmentSessionState.fromJson(Map<String, dynamic> json) =>
      _$EquipmentSessionStateFromJson(json);
}
...
class WorkflowSessionState with _$WorkflowSessionState {
  ...
  factory WorkflowSessionState.fromJson(Map<String, dynamic> json) =>
      _$WorkflowSessionStateFromJson(json);
}
...
class AppSessionState with _$AppSessionState {
  ...
  factory AppSessionState.fromJson(Map<String, dynamic> json) =>
      _$AppSessionStateFromJson(json);
}
...
class MakeModelConverter extends JsonConverter<String, Object?> {
  const MakeModelConverter();

  @override
  String fromJson(Object? json) => _makeModelFromJson(json);

  @override
  Object? toJson(String object) => _makeModelToJson(object);
}
