...
void main() {
  final analyzer = DeviceOcrAnalyzer();
  ...
  group('DeviceOcrAnalyzer', () {
    ...
    group('Model extraction', () {
      ...
      test('extracts HP models', () {
        ...
        final model = analysis.primarySuggestionFor('makeModel')?.value;
        expect(model,
            equals('HP ProBook 450')); // Correct capitalization
      });
      ...
      test('extracts Lenovo models', () {
        ...
        expect(
            model,
            equals(
                'Lenovo ThinkPad X1')); // Correct capitalization
      });
      ...
      test('extracts MacBook models', () {
        ...
        final model = analysis.primarySuggestionFor('makeModel')?.value;
        expect(model,
            equals('MacBook Pro 14')); // Correct capitalization
      });
      ...
      test('capitalizes model names correctly', () {
        ...
        expect(
            model,
            equals(
                'Dell OptiPlex 7090')); // Correct capitalization
      });
    });
    ...
    group('Multiple suggestions handling', () {
      ...
      test('handles empty results gracefully', () {
        ...
        expect(analysis.modelSuggestions, isEmpty); // Better filtering means no false positives
